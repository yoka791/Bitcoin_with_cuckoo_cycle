...
bool SetStartOnSystemStartup(bool fAutoStart)
{
    ...
    if (fAutoStart)
    {
        ...
        if (SUCCEEDED(hres))
        {
            ...
            strArgs += QString::fromStdString(strprintf(" -testnet=%d -cuckoo=%d", GetBoolArg("-testnet", false), GetBoolArg("-cuckoo", false)));
...
bool SetStartOnSystemStartup(bool fAutoStart)
{
    ...
    else
    {
        ...
        optionFile << "Exec=" << pszExePath << strprintf(" -min -testnet=%d -cuckoo=%d\n", GetBoolArg("-testnet", false), GetBoolArg("-cuckoo", false));
